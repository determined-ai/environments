...
CPU_SUFFIX := -cpu
GPU_PREFIX := determinedai/environments:cuda-10-
GPU_SUFFIX := -gpu

export CPU_TF1_ENVIRONMENT_NAME := $(CPU_PREFIX)pytorch-1.4-tf-1.14$(CPU_SUFFIX)
export GPU_TF1_ENVIRONMENT_NAME := $(GPU_PREFIX)pytorch-1.4-tf-1.14$(GPU_SUFFIX)
export CPU_TF2_ENVIRONMENT_NAME := $(CPU_PREFIX)pytorch-1.4-tf-2.1$(CPU_SUFFIX)
export GPU_TF2_ENVIRONMENT_NAME := $(GPU_PREFIX)pytorch-1.4-tf-2.1$(GPU_SUFFIX)
